...
# ============================================================ DEPRECATED
"""Content + page assembly for guelphhvacpros.ca. Run: python3 build_pages.py"""
...
SVC = {
 "furnace-repair": {
   ...
   "intro":"When your furnace stops working, you need fast, dependable service you can trust. At Guelph HVAC Pros, we provide expert furnace repair in Guelph, Ontario and surrounding Wellington County communities to restore warmth, safety, and efficiency to your home. Our skilled technicians quickly diagnose issues and deliver lasting repairs, helping you stay comfortable through every cold Ontario winter.",
   ...
   "problem_p":"Guelph HVAC Pros provides expert furnace repair in Guelph, ON to keep homes warm, safe, and efficient through the coldest months.",
   "features":[
 ...
 "ac-repair": {
   ...
   "problem_p":"Guelph HVAC Pros provides expert AC repair in Guelph, ON for central air, ductless mini-splits, and high-efficiency systems.",
   "features":[
 ...
 "ductless-ac-installation": {
   ...
   "intro":"Experience reliable, energy-efficient cooling with professional ductless AC installation from Guelph HVAC Pros. Serving Guelph, Ontario and surrounding Wellington County areas, our expert technicians install high-performance ductless air conditioning systems that provide customizable comfort year-round. Ideal for homes without traditional ductwork, our solutions deliver quiet, efficient cooling while helping you save on energy costs.",
   ...
   "problem_p":"Guelph HVAC Pros provides ductless AC installation for efficient, flexible cooling that reduces energy costs and keeps every room comfortable.",
   "features":[
 ...
 "heat-pump-repair-installation": {
   ...
   "intro":"For reliable heat pump repair and installation in Guelph, Ontario, trust the experienced team at Guelph HVAC Pros. We provide expert heat pump services designed to keep your home efficient and comfortable in every season, from cold winters to hot, humid summers. Whether you need fast repairs, routine maintenance, or a new energy-efficient system, our skilled technicians deliver dependable solutions.",
   ...
   "problem_p":"Guelph HVAC Pros provides expert heat pump repair and installation in Guelph, Ontario for reliable year-round comfort and lower energy bills.",
   "features":[
 ...
 "fireplace-installation": {
   ...
   "intro":"Enhance your home's warmth and style with professional fireplace installation from Guelph HVAC Pros. Serving Guelph, Ontario and surrounding Wellington County areas, our skilled team ensures safe, efficient, and beautiful installations that complement any space. From modern gas units to classic wood-burning fireplaces, we provide expert guidance and quality workmanship to create a cozy, inviting atmosphere.",
   ...
   "problem_p":"Guelph HVAC Pros provides professional fireplace installation, ensuring safe, efficient, code-compliant fireplaces beautifully integrated into your home.",
   "features":[
 ...
 "thermostat-repair-replacement": {
   ...
   "intro":"Stay in control of your home's comfort with professional thermostat repair and replacement from Guelph HVAC Pros. We provide expert thermostat services in Guelph, Ontario and surrounding Wellington County areas, ensuring accurate temperature control, improved energy efficiency, and reliable system performance. Whether you need a quick repair, a smart-thermostat upgrade, or a full replacement, our technicians deliver dependable solutions.",
...
SVC_PHOTO_FALLBACK = ("wp/Guelph-Ontario-HVAC-technician.png", "Guelph HVAC Pros HVAC technician in service")
SVC_PHOTO = {
 ...
 "ductless-ac-installation": ("wp/Guelph-Ontario-HVAC-Contractor.png", "Ductless mini-split installation"),
 "heat-pump-repair-installation": ("wp/Guelph-Ontario-HVAC-Contractor.png", "Heat pump repair and installation"),
 "fireplace-installation": ("wp/Guelph-Ontario-HVAC-Contractor.png", "Fireplace installation"),
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>Guelph HVAC Pros, {data["h1"]}</h1>
...
def build_home():
    ...
    out = head(
      ...
      desc=f"Guelph HVAC Pros provides honest, efficient, dependable HVAC service in {CITY}, Ontario, furnace & AC repair, heat pumps & more. Call {PHONE_DISPLAY} for a free quote.",
      path="/",
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p class="lead">At Guelph HVAC Pros, we understand that a broken air conditioner or failing furnace is more than an inconvenience, it's a disruption to your life.</p>
      ...
      <div class="split__media reveal d1">
        <img class="media-photo" src="/assets/img/wp/Guelph-Ontario-HVAC-technician.png" alt="Guelph HVAC Pros HVAC technician servicing a system" width="640" height="640" loading="lazy" decoding="async">
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>Why Choose Guelph HVAC Pros?</h2>
...
def build_about():
    out = head(
      ...
      desc=f"Guelph HVAC Pros is a local, family-run HVAC company serving Guelph, Ontario with honest, reliable heating and cooling care. Meet the team.",
      path="/about/",
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p>At <a href="/">Guelph HVAC Pros</a>, we believe every family deserves a comfortable, healthy home. As a family-oriented business based in Guelph, Ontario, our mission is simple: keep your home comfortable through every season with the same high standard of care we'd expect for our own households.</p>
...
{cta_band(title="Experience the Guelph HVAC Pros Difference",
...
def build_contact():
    out = head(
      ...
      desc=f"Contact Guelph HVAC Pros for fast, friendly HVAC service in Guelph, Ontario. Call {PHONE_DISPLAY} or request a free quote online. Open 24/7.",
      path="/contact/",
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Is your air conditioner making a strange noise? Ready to upgrade your furnace before winter? Whatever your home comfort need, the <a href="/">Guelph HVAC Pros</a> team is ready to help, without the stress.</p>
  </div>
</section>
...
BLOG = [
 {"slug":"how-often-should-you-service-your-hvac-system-in-guelph-ontario",
  ...
  "photo":"/assets/img/blog/how-often-should-you-service-your-hvac-system-in-guelph-ontario.jpg",
  "photo_h":1067,
  "photo_alt":"HVAC technician inspecting an outdoor air conditioning unit with a flashlight during a maintenance visit",
 ...
 {"slug":"signs-your-furnace-needs-repair-before-a-guelph-winter",
  ...
  "photo":"/assets/img/blog/signs-your-furnace-needs-repair-before-a-guelph-winter.jpg",
  "photo_h":1067,
  "photo_alt":"Technician's gloved hands adjusting the control panel of a furnace during a repair",
 ...
 {"slug":"why-your-air-conditioner-struggles-during-humid-guelph-summers",
  ...
  "photo":"/assets/img/blog/why-your-air-conditioner-struggles-during-humid-guelph-summers.jpg",
  "photo_h":1274,
  "photo_alt":"Technician repairing a rooftop air conditioning unit on a sunny day",
  ...
  <div class="container">
    <article class="article reveal">
      ...
      <div class="note-banner" style="margin-top:30px;background:var(--bg-alt);border:1px solid var(--line);color:var(--body)">
        ...
        For professional <a href="{rsvc[0]}">{rsvc[1]} in {CITY}</a>, our team is ready to help. <a href="/contact/">Request a free quote</a> and a local Guelph technician will get back to you fast, we're here 24/7.
      </div>
    </article>
  </div>
</section>
...
<p>At Guelph HVAC Pros, we often hear the same question: <em>how often should I service my heating and cooling system?</em> Our answer is simple. At minimum, twice per year.</p>
...
<h2>Book Your Service With Guelph HVAC Pros</h2>
...
def build_privacy():
    out = head(title=f"Privacy Policy | {SITE_NAME}",
      desc="Privacy policy for Guelph HVAC Pros, how we collect, use, and protect your personal information.",
      path="/privacy-policy/",
...
def build_root_files():
    write_root("CNAME", "guelphhvacpros.ca\n")
